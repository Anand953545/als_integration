...
/**
  ...
  @param    memory_ptr  Pointer to allocating memory
  @param    memory_size Required size of memory for allocation
...
/**
  ...
  @param    memory_ptr  Releasing memory
  @return   0 for success, -1 for failure
 */
/*--------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/**
  @brief	Get allocated memory for use
